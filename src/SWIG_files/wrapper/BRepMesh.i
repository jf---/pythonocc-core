...
%feature("shadow") BRepMesh_Circle::~BRepMesh_Circle %{
def __del__(self):
	try:
		self.thisown = False
...
") Allocator;
		inline const Handle_NCollection_IncAllocator & Allocator ();
...
") Result;
		inline const Handle_BRepMesh_DataStructureOfDelaun & Result ();
...
%feature("shadow") BRepMesh_EdgeChecker::~BRepMesh_EdgeChecker %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") BRepMesh_EdgeParameterProvider::~BRepMesh_EdgeParameterProvider %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend BRepMesh_EdgeParameterProvider {
	void _kill_pointed() {
		delete $self;
	}
};
...
%feature("shadow") BRepMesh_FaceChecker::~BRepMesh_FaceChecker %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") BRepMesh_IEdgeTool::~BRepMesh_IEdgeTool %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") BRepMesh_OrientedEdge::~BRepMesh_OrientedEdge %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
") First;
		inline const Handle_Poly_PolygonOnTriangulation & First ();
		%feature("compactdefaultargs") Last;
		%feature("autodoc", "	* Returns last polygon on triangulation.

	:rtype: inline  Handle_Poly_PolygonOnTriangulation
") Last;
		inline const Handle_Poly_PolygonOnTriangulation & Last ();
};
...
%feature("shadow") BRepMesh_WireChecker::~BRepMesh_WireChecker %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") BRepMesh_EdgeTessellationExtractor::~BRepMesh_EdgeTessellationExtractor %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") BRepMesh_EdgeTessellator::~BRepMesh_EdgeTessellator %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend BRepMesh_EdgeTessellator {
	void _kill_pointed() {
		delete $self;
	}
};
