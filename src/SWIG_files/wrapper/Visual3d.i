...
") SetValue;
	...
	:rtype: Handle_Visual3d_Light
") Value;
		const Handle_Visual3d_Light & Value (const Standard_Integer anIndex);
...
%feature("shadow") Visual3d_HSequenceOfLight::~Visual3d_HSequenceOfLight %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend Visual3d_HSequenceOfLight {
	Handle_Visual3d_HSequenceOfLight GetHandle() {
	return *(Handle_Visual3d_HSequenceOfLight*) &$self;
	}
};
...
%feature("shadow") Handle_Visual3d_HSequenceOfLight::~Handle_Visual3d_HSequenceOfLight %{
def __del__(self):
    try:
        self.thisown = False
        OCC.GarbageCollector.garbage.collect_object(self)
...
") Value;
		const Handle_Visual3d_View & Value (const Standard_Integer anIndex);
		%feature("compactdefaultargs") ChangeValue;
		%feature("autodoc", "	:param anIndex:
	:type anIndex: int
	:rtype: Handle_Visual3d_View
...
%feature("shadow") Visual3d_HSequenceOfView::~Visual3d_HSequenceOfView %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend Visual3d_HSequenceOfView {
	Handle_Visual3d_HSequenceOfView GetHandle() {
	return *(Handle_Visual3d_HSequenceOfView*) &$self;
	}
};
...
%feature("shadow") Handle_Visual3d_HSequenceOfView::~Handle_Visual3d_HSequenceOfView %{
def __del__(self):
    try:
        self.thisown = False
        OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Visual3d_SequenceNodeOfSequenceOfLight::~Visual3d_SequenceNodeOfSequenceOfLight %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend Visual3d_SequenceNodeOfSequenceOfLight {
	Handle_Visual3d_SequenceNodeOfSequenceOfLight GetHandle() {
	return *(Handle_Visual3d_SequenceNodeOfSequenceOfLight*) &$self;
	}
};
...
%feature("shadow") Handle_Visual3d_SequenceNodeOfSequenceOfLight::~Handle_Visual3d_SequenceNodeOfSequenceOfLight %{
def __del__(self):
    try:
        self.thisown = False
        OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Visual3d_SequenceNodeOfSequenceOfView::~Visual3d_SequenceNodeOfSequenceOfView %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend Visual3d_SequenceNodeOfSequenceOfView {
	Handle_Visual3d_SequenceNodeOfSequenceOfView GetHandle() {
	return *(Handle_Visual3d_SequenceNodeOfSequenceOfView*) &$self;
	}
};
...
%feature("shadow") Handle_Visual3d_SequenceNodeOfSequenceOfView::~Handle_Visual3d_SequenceNodeOfSequenceOfView %{
def __del__(self):
    try:
        self.thisown = False
        OCC.GarbageCollector.garbage.collect_object(self)
...
") InsertAfter;
		...
		%feature("autodoc", "	:rtype: Handle_Visual3d_Light
") First;
		const Handle_Visual3d_Light & First ();
		%feature("compactdefaultargs") Last;
		%feature("autodoc", "	:rtype: Handle_Visual3d_Light
") Last;
		const Handle_Visual3d_Light & Last ();
		%feature("compactdefaultargs") Split;
		%feature("autodoc", "	:param Index:
	:type Index: int
	:param Sub:
...
") Split;
	...
	:rtype: Handle_Visual3d_Light
") Value;
		const Handle_Visual3d_Light & Value (const Standard_Integer Index);
		%feature("compactdefaultargs") SetValue;
		%feature("autodoc", "	:param Index:
	:type Index: int
	:param I:
...
%feature("shadow") Visual3d_SequenceOfLight::~Visual3d_SequenceOfLight %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
") InsertAfter;
		...
		%feature("autodoc", "	:rtype: Handle_Visual3d_View
") First;
		const Handle_Visual3d_View & First ();
		%feature("compactdefaultargs") Last;
		%feature("autodoc", "	:rtype: Handle_Visual3d_View
") Last;
		const Handle_Visual3d_View & Last ();
		%feature("compactdefaultargs") Split;
		%feature("autodoc", "	:param Index:
	:type Index: int
	:param Sub:
...
") Split;
	...
	:rtype: Handle_Visual3d_View
") Value;
		const Handle_Visual3d_View & Value (const Standard_Integer Index);
		%feature("compactdefaultargs") SetValue;
		%feature("autodoc", "	:param Index:
	:type Index: int
	:param I:
...
%feature("shadow") Visual3d_SequenceOfView::~Visual3d_SequenceOfView %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
