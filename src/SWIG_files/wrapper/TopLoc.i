...
%feature("shadow") TopLoc_SListNodeOfItemLocation::~TopLoc_SListNodeOfItemLocation %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend TopLoc_SListNodeOfItemLocation {
	Handle_TopLoc_SListNodeOfItemLocation GetHandle() {
	return *(Handle_TopLoc_SListNodeOfItemLocation*) &$self;
	}
};
...
%feature("shadow") Handle_TopLoc_SListNodeOfItemLocation::~Handle_TopLoc_SListNodeOfItemLocation %{
def __del__(self):
    try:
        self.thisown = False
        OCC.GarbageCollector.garbage.collect_object(self)
