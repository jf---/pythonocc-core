...
%feature("shadow") Graphic3d_Attribute::~Graphic3d_Attribute %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Graphic3d_BoundBuffer::~Graphic3d_BoundBuffer %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Graphic3d_CAspectFillArea::~Graphic3d_CAspectFillArea %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Graphic3d_CAspectLine::~Graphic3d_CAspectLine %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Graphic3d_CAspectMarker::~Graphic3d_CAspectMarker %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Graphic3d_CAspectText::~Graphic3d_CAspectText %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Graphic3d_Camera::~Graphic3d_Camera %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Graphic3d_RenderingParams::~Graphic3d_RenderingParams %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
