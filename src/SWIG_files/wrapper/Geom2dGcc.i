...
%feature("shadow") Geom2dGcc_Circ2d2TanOnGeo::~Geom2dGcc_Circ2d2TanOnGeo %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_Circ2d2TanOnIter::~Geom2dGcc_Circ2d2TanOnIter %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_Circ2d2TanRadGeo::~Geom2dGcc_Circ2d2TanRadGeo %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_Circ2d3TanIter::~Geom2dGcc_Circ2d3TanIter %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_Circ2dTanCenGeo::~Geom2dGcc_Circ2dTanCenGeo %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_Circ2dTanOnRadGeo::~Geom2dGcc_Circ2dTanOnRadGeo %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_CurveToolGeo::~Geom2dGcc_CurveToolGeo %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_FunctionTanCirCu::~Geom2dGcc_FunctionTanCirCu %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_FunctionTanCuCu::~Geom2dGcc_FunctionTanCuCu %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_FunctionTanCuCuOnCu::~Geom2dGcc_FunctionTanCuCuOnCu %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_FunctionTanCuPnt::~Geom2dGcc_FunctionTanCuPnt %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_FunctionTanObl::~Geom2dGcc_FunctionTanObl %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_Lin2d2TanIter::~Geom2dGcc_Lin2d2TanIter %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_Lin2dTanOblIter::~Geom2dGcc_Lin2dTanOblIter %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") Geom2dGcc_QCurve::~Geom2dGcc_QCurve %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
