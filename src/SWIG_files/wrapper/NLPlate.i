...
%feature("shadow") NLPlate_ListIteratorOfStackOfPlate::~NLPlate_ListIteratorOfStackOfPlate %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%feature("shadow") NLPlate_ListNodeOfStackOfPlate::~NLPlate_ListNodeOfStackOfPlate %{
def __del__(self):
	try:
		self.thisown = False
		OCC.GarbageCollector.garbage.collect_object(self)
...
%extend NLPlate_ListNodeOfStackOfPlate {
	Handle_NLPlate_ListNodeOfStackOfPlate GetHandle() {
	return *(Handle_NLPlate_ListNodeOfStackOfPlate*) &$self;
	}
};
...
%feature("shadow") Handle_NLPlate_ListNodeOfStackOfPlate::~Handle_NLPlate_ListNodeOfStackOfPlate %{
def __del__(self):
    try:
        self.thisown = False
        OCC.GarbageCollector.garbage.collect_object(self)
